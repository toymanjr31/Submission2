...
import com.dicoding.androidprogramming.submission2.databinding.FragmentFollowingBinding
...
class FollowingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        list.clear()
        val userData = activity!!.intent.getParcelableExtra<User>(EXTRA_DATA) as User
